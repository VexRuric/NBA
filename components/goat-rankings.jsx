...
const players = [
  { name: "Michael Jordan", gp: 1072, ppg: 30.1, rpg: 6.2, apg: 5.3, bpg: 0.8, spg: 2.3, per: 27.91, ts: 56.9, playoffPPG: 33.4, rings: 6, mvp: 5, fmvp: 6, allStar: 14, allNBA: 10, dpoy: 1, estimatedBPG: null, notes: "Highest career PER ever. Best SPG of any player on this list. Playoff PPG exceeds regular season — got BETTER under pressure." },
  { name: "Wilt Chamberlain", gp: 1045, ppg: 30.1, rpg: 22.9, apg: 4.4, bpg: null, spg: 2.2, per: 26.13, ts: 57.0, playoffPPG: 22.9, rings: 2, mvp: 4, fmvp: 1, allStar: 13, allNBA: 7, dpoy: 0, estimatedBPG: 8.15, notes: "BPG confirmed 8.15 avg across 180 documented games (Basketball Reference, April 2026). SPG 2.2 via film breakdown. 30.1 PPG + 22.9 RPG + 8.15 BPG + 2.2 SPG is the most dominant all-around profile in NBA history." },
  { name: "LeBron James", gp: 1622, ppg: 26.8, rpg: 7.5, apg: 7.4, bpg: 0.7, spg: 1.6, per: 27.49, ts: 58.7, playoffPPG: 28.6, rings: 4, mvp: 4, fmvp: 4, allStar: 21, allNBA: 13, dpoy: 0, estimatedBPG: null, notes: "Only player elite in PPG, RPG & APG simultaneously. All-time scoring leader. Most games played of any top-5 player." },
  { name: "Bill Russell", gp: 963, ppg: 15.1, rpg: 22.5, apg: 4.3, bpg: null, spg: null, per: 21.9, ts: 51.0, playoffPPG: 16.2, rings: 11, mvp: 5, fmvp: 0, allStar: 12, allNBA: 3, dpoy: 0, estimatedBPG: 8.6, notes: "Estimated 8.6 BPG + 22.5 RPG = greatest defensive statistical profile ever. 11 rings. Low PPG is his only weakness on a stats list. 5 MVPs but FMVP award didn't exist for most of his career." },
  { name: "Kareem Abdul-Jabbar", gp: 1560, ppg: 24.6, rpg: 11.2, apg: 3.6, bpg: 2.57, spg: 0.9, per: 24.58, ts: 57.0, playoffPPG: 24.3, rings: 6, mvp: 6, fmvp: 2, allStar: 19, allNBA: 10, dpoy: 0, estimatedBPG: null, notes: "Elite across PPG, RPG & BPG over 1,560 games. Led league in PER 9 times. 6 rings, 6 MVPs. Skyhook literally unguardable." },
  { name: "Hakeem Olajuwon", gp: 1238, ppg: 21.8, rpg: 11.1, apg: 2.5, bpg: 3.09, spg: 1.75, per: 23.59, ts: 55.1, playoffPPG: 25.9, rings: 2, mvp: 1, fmvp: 2, allStar: 12, allNBA: 6, dpoy: 2, estimatedBPG: null, notes: "Highest official BPG on list. 1.75 SPG insane for a center. 2 DPOY awards. Playoff PPG higher than regular season. Best verified two-way big ever on paper." },
  { name: "Magic Johnson", gp: 906, ppg: 19.5, rpg: 7.2, apg: 11.2, bpg: 0.4, spg: 1.9, per: 24.11, ts: 56.8, playoffPPG: 19.5, rings: 5, mvp: 3, fmvp: 3, allStar: 12, allNBA: 9, dpoy: 0, estimatedBPG: null, notes: "Highest career APG ever at 11.2. 1.9 SPG elite for a point guard. Revolutionized the position at 6'9\". Retired early — numbers could be higher." },
  { name: "Oscar Robertson", gp: 1040, ppg: 25.7, rpg: 7.5, apg: 9.5, bpg: 0.2, spg: null, per: 24.08, ts: 53.4, playoffPPG: 22.2, rings: 1, mvp: 1, fmvp: 0, allStar: 12, allNBA: 9, dpoy: 0, estimatedBPG: null, notes: "Averaged a triple-double for an ENTIRE season (1961-62). Elite PPG + APG combo. SPG not tracked in his era." },
  { name: "Shaquille O'Neal", gp: 1207, ppg: 23.7, rpg: 10.9, apg: 2.5, bpg: 2.26, spg: 0.6, per: 26.43, ts: 58.4, playoffPPG: 24.3, rings: 4, mvp: 1, fmvp: 3, allStar: 15, allNBA: 8, dpoy: 0, estimatedBPG: null, notes: "4th highest career PER ever. Shot 58.2% FG — most efficient high-volume scorer on this list. 3 consecutive Finals MVPs." },
  { name: "Kevin Durant", gp: 1100, ppg: 27.3, rpg: 6.6, apg: 3.4, bpg: 1.1, spg: 1.1, per: 25.91, ts: 61.9, playoffPPG: 28.4, rings: 2, mvp: 1, fmvp: 2, allStar: 14, allNBA: 6, dpoy: 0, estimatedBPG: null, notes: "2nd highest TS% on this list at 61.9%. Best BPG of any wing player here. Playoff PPG higher than regular season." },
  { name: "Tim Duncan", gp: 1392, ppg: 19.0, rpg: 10.8, apg: 3.0, bpg: 2.17, spg: 0.7, per: 23.44, ts: 55.3, playoffPPG: 20.6, rings: 5, mvp: 2, fmvp: 3, allStar: 15, allNBA: 10, dpoy: 0, estimatedBPG: null, notes: "2.17 BPG over 1,392 games is extraordinary. Most consistent two-way big of modern era. 3 Finals MVPs. Playoff PPG always higher than reg season." },
  { name: "Karl Malone", gp: 1476, ppg: 25.0, rpg: 10.1, apg: 3.6, bpg: 0.8, spg: 1.4, per: 23.90, ts: 54.1, playoffPPG: 23.8, rings: 0, mvp: 2, fmvp: 0, allStar: 14, allNBA: 11, dpoy: 0, estimatedBPG: null, notes: "36,928 career points (3rd all time). 1,476 games of elite production. 2 MVPs, 11 All-NBA 1st teams. Volume and durability unmatched among forwards. 0 rings." },
  { name: "Jerry West", gp: 932, ppg: 27.0, rpg: 5.8, apg: 6.7, bpg: 0.6, spg: null, per: 22.88, ts: 54.0, playoffPPG: 29.1, rings: 1, mvp: 0, fmvp: 1, allStar: 14, allNBA: 10, dpoy: 0, estimatedBPG: null, notes: "Playoff PPG of 29.1 — nearly matches Jordan's playoff average. SPG not tracked in era. Only player to win Finals MVP on the losing team." },
  { name: "Stephen Curry", gp: 1000, ppg: 24.8, rpg: 4.8, apg: 6.6, bpg: 0.2, spg: 1.7, per: 23.51, ts: 62.6, playoffPPG: 26.5, rings: 4, mvp: 2, fmvp: 1, allStar: 11, allNBA: 4, dpoy: 0, estimatedBPG: null, notes: "Highest TS% on this entire list at 62.6%. All-time 3PT record. Literally changed how basketball is played." },
  { name: "Larry Bird", gp: 897, ppg: 24.3, rpg: 10.0, apg: 6.3, bpg: 0.8, spg: 1.8, per: 23.50, ts: 53.6, playoffPPG: 23.8, rings: 3, mvp: 3, fmvp: 2, allStar: 12, allNBA: 9, dpoy: 0, estimatedBPG: null, notes: "Elite across PPG, RPG, APG & SPG. 3 consecutive MVPs, 2 Finals MVPs. Career cut short by injuries — peak efficiency was among the best ever." },
  { name: "Kobe Bryant", gp: 1346, ppg: 25.0, rpg: 5.2, apg: 4.7, bpg: 0.5, spg: 1.4, per: 22.90, ts: 55.0, playoffPPG: 25.6, rings: 5, mvp: 1, fmvp: 2, allStar: 18, allNBA: 11, dpoy: 0, estimatedBPG: null, notes: "5 rings over 20 seasons. 18 All-Star selections, 11 All-NBA 1st teams. Elite scorer with strong playoff numbers. Consistency across a massive sample size." },
  { name: "Giannis Antetokounmpo", gp: 820, ppg: 28.3, rpg: 11.4, apg: 5.8, bpg: 1.3, spg: 1.2, per: 26.50, ts: 61.0, playoffPPG: 27.8, rings: 1, mvp: 2, fmvp: 1, allStar: 10, allNBA: 6, dpoy: 1, estimatedBPG: null, notes: "2 MVPs, 1 Finals MVP, 1 DPOY. Elite across PPG, RPG & BPG. Still active — resume still building but numbers already elite." },
  { name: "Charles Barkley", gp: 1073, ppg: 22.1, rpg: 11.7, apg: 3.9, bpg: 0.8, spg: 1.5, per: 24.63, ts: 57.2, playoffPPG: 23.0, rings: 0, mvp: 1, fmvp: 0, allStar: 11, allNBA: 5, dpoy: 0, estimatedBPG: null, notes: "1 MVP. Exceptional rebounder for his size. High PER and TS% but 0 rings and lower PPG limits ceiling." },
  { name: "Kevin Garnett", gp: 1462, ppg: 17.8, rpg: 10.0, apg: 3.7, bpg: 1.4, spg: 1.3, per: 22.35, ts: 53.3, playoffPPG: 18.4, rings: 1, mvp: 1, fmvp: 0, allStar: 15, allNBA: 4, dpoy: 1, estimatedBPG: null, notes: "Elite two-way player. 1 MVP, 1 DPOY, 1 ring. Strong BPG and SPG but lower PPG caps his score on offense-weighted lists." },
  { name: "Julius Erving", gp: 836, ppg: 22.0, rpg: 6.7, apg: 3.9, bpg: 1.7, spg: 2.0, per: 22.50, ts: 54.0, playoffPPG: 21.9, rings: 1, mvp: 1, fmvp: 1, allStar: 11, allNBA: 4, dpoy: 0, estimatedBPG: null, notes: "NBA stats only. Add ABA (28.7 PPG) and his case is significantly stronger. Pioneer who defined the position." },
  { name: "Dirk Nowitzki", gp: 1522, ppg: 20.7, rpg: 7.5, apg: 2.4, bpg: 0.8, spg: 0.8, per: 23.00, ts: 58.7, playoffPPG: 22.0, rings: 1, mvp: 1, fmvp: 1, allStar: 14, allNBA: 4, dpoy: 0, estimatedBPG: null, notes: "1 MVP, 1 ring. Played 21 seasons. Revolutionized the power forward position. High TS% reflects elite efficiency." },
  { name: "Nikola Jokic", gp: 810, ppg: 22.2, rpg: 11.1, apg: 7.5, bpg: 0.8, spg: 1.4, per: 29.17, ts: 64.1, playoffPPG: 24.5, rings: 1, mvp: 3, fmvp: 1, allStar: 7, allNBA: 5, dpoy: 0, estimatedBPG: null, notes: "Highest TS% (64.1%) and highest career playoff PER (29.17) on this entire list. Only player to average a triple-double as a center. 3 MVPs, still active." },
    ...
    <div onClick={onSelect} style={{ background: selected ? (isBubble?"#1a2a3a":"#1e3050") : (isBubble?"#131e2d":"#1a2535"), border:`1px solid ${selected?"#FFD700":isBubble?"#1e2c3d":"#2a3545"}`, borderRadius:10, padding:"11px 15px", cursor:"pointer", transition:"all 0.15s" }}>
      ...
      {selected && (
        <div style={{ marginTop:13, borderTop:"1px solid #2a3545", paddingTop:11 }}>
          <div style={{ fontSize:11, color:"#556677", fontWeight:700, textTransform:"uppercase", letterSpacing:1, marginBottom:6 }}>Performance</div>
  ...
  return (
    <div style={{ fontFamily:"'Segoe UI', sans-serif", background:"#0f1923", minHeight:"100vh", color:"#e8eaf0", padding:"20px 14px" }}>
      <div style={{ maxWidth:860, margin:"0 auto" }}>
        ...
        {/* Performance Weights Panel */}
        <div style={{ background:"#1a2535", borderRadius:12, marginBottom:12, overflow:"hidden" }}>
        ...
        <div style={{ background:"#16172a", borderRadius:12, marginBottom:20, overflow:"hidden", border:"1px solid #2a1f4a" }}>
          ...
          {showAccolades && (
            <div style={{ padding:"4px 14px 16px" }}>
              ...
              <button onClick={() => { setW({...defaultWeights}); setSelected(null); }} style={{ marginTop:12, width:"100%", background:"#2a2040", border:"none", color:"#b57bee", fontSize:12, padding:"9px", borderRadius:8, cursor:"pointer" }}>
        ...
        <p style={{ textAlign:"center", fontSize:11, color:"#334455", marginTop:14 }}>
          Set any weight to 0 to remove that stat. Adjust 🏆 Rings or MVP weights to see dramatic ranking shifts.
        </p>
      </div>
    </div>
  );
